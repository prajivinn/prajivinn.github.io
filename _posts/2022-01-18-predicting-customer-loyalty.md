...
While Random Forest model demonstrates strong predictive performance, further variables can be explored by incorporating additional customer-level and behavioral features such as purchase frequency trends, recency of transactions, promotional responsiveness, and channel preferences (e.g., online vs in-store). These features can provide deeper insights into customer engagement and loyalty patterns.
...
Continuous monitoring and periodic retraining of the model would be important to capture changing customer preferences and maintain prediction accuracy over time.
<br>
<br>
...
loyalty_scores = pd.read_excel(r'/Users/praju/Desktop/DSI/Untitled Folder/grocery_database.xlsx',sheet_name="loyalty_scores")
customer_details = pd.read_excel(r'/Users/praju/Desktop/DSI/Untitled Folder/grocery_database.xlsx',sheet_name="customer_details")
